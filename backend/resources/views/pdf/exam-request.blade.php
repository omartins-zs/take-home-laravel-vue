...
<head>
  <style>
    ...
    .title { font-size: 16px; font-weight: bold; margin-top: 20px; }
    .group-box { border: 1px solid #ccc; padding: 10px; margin-bottom: 20px; }
    .obs { font-style: italic; margin-top: 10px; }
  </style>
</head>
<body>
  ...
  <p><strong>Paciente:</strong> {{ $patient['name'] }} | <strong>Nascimento:</strong> {{ $patient['birth_date'] }} | <strong>Sexo:</strong> {{ $patient['gender'] }}</p>
